...
# 재료 목록 넣기
with open('../DataTools/Data/result/ingredients_list.json', 'r') as f :
    data = json.load(f)
cur = conn.cursor()
for item in data :
    ...
    cur.execute("INSERT INTO ingredient (name, major_id, middle_id, sub_id) VALUES (%s, %s, %s, %s)", (name, major_id, middle_id, sub_id))
conn.commit()
print("데이터 삽입 완료")
