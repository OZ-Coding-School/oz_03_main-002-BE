...
# 중분류 코드
middle_code = df[['식품대분류코드', '식품중분류명','식품중분류코드']]

middle_code = middle_code.rename(
    columns={"식품대분류코드" : 'major_code', "식품중분류코드": "middle_code", "식품중분류명": "middle_name"}
)
...
# 소분류 코드
sub_code = (
    df[["식품중분류코드","식품소분류코드", "식품소분류명"]]
    .reset_index(drop=True)
)
sub_code = sub_code.rename(
    columns={"식품중분류코드" : "middle_code","식품소분류코드": "sub_code", "식품소분류명": "sub_name"}
)
